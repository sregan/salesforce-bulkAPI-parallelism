//args (object,file)
//compile: javac -cp C:\temp\java\partner.jar;c:\temp\java\wsc\force-wsc-29.0.0.jar BulkLoadSerial.java
//run: java -cp .;partner.jar;wsc\force-wsc-29.0.0.jar BulkLoadSerial Order__c OrderDataSerial.csv
