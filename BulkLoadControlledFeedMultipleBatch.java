//args (object,file)
//compile: javac -cp C:\temp\java\partner.jar;c:\temp\java\wsc\force-wsc-29.0.0.jar BulkLoadParallelWait10.java
//run: java -cp .;partner.jar;wsc\force-wsc-29.0.0.jar BulkLoadParallelWait10 Order__c OrderDataOrdered.csv
