//args (object,file)
//compile: javac -cp C:\temp\java\partner.jar;c:\temp\java\wsc\force-wsc-29.0.0.jar BulkLoadParallelWait.java
//run: java -cp .;partner.jar;wsc\force-wsc-29.0.0.jar BulkLoadParallelWait Order__c OrderDataParallelWait.csv
...
public class BulkLoadControlledFeedSingleBatch {


	public static void main(String[] args)
			throws AsyncApiException, ConnectionException, IOException {
		BulkLoadControlledFeedSingleBatch bl = new BulkLoadControlledFeedSingleBatch();
	...
	public void runSample(String sobjectType, String userName,
		...
		createBatchesFromCSVFile(sobjectType, connection, sampleFileName);
	}
	...
	private BulkConnection getBulkConnection(String userName, String password)
		...
		partnerConfig.setAuthEndpoint("https://login.salesforce.com/services/Soap/u/29.0");
	 ...
	 */
	private List<BatchInfo> createBatchesFromCSVFile(String sobjectType, BulkConnection connection,
			String csvFileName)
