//args (object,file)
//compile: javac -cp C:\temp\java\partner.jar;c:\temp\java\wsc\force-wsc-29.0.0.jar BulkLoadParallel.java
//run: java -cp .;partner.jar;wsc\force-wsc-29.0.0.jar BulkLoadParallel Order__c OrderData.csv
...
public class BulkLoadParallel {

	public static void main(String[] args)
			throws AsyncApiException, ConnectionException, IOException {
		BulkLoadParallel bl = new BulkLoadParallel();
